    ...
    public partial class setup : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table => { table.PrimaryKey("PK_Playlist", x => x.ID); });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table => { table.PrimaryKey("PK_Song", x => x.ID); });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    {
                        4, "Hey Hey Hey - Carlos feat Bitconnect", "-1", "/songs/bitconnect-remix-warning-scam.mp3",
                        "Scam,Bold man"
                    },
                    {
                        5, "The song of the great Monarch - Sylvain Durif ", "-1",
                        "/songs/la-chanson-du-grand-monarque-sylvain-durif-cest-moi.mp3", "cloud"
                    },
                    {
                        6, "I've Had The Time Of My Life", "-1",
                        "/songs/dirty-dancing-soundtrack-ive-had-the-time-of-my-life.mp3", "Dirty Dancing"
                    }
                });
        }
